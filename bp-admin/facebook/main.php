...
add_action('admin_menu', 'blogpress');
//Add styling page
...
<?php _e('Facebook is otimized for blogpress.', 'custom-facebook-feed' ); ?>
</strong></p></div>
    <?php } ?> 
 
    <div id="cff-admin" class="wrap">
        <div id="header">
            <h2><?php _e('Facebook for Blogpress'); ?></h2>
        </div>
        ...
        <h2 class="nav-tab-wrapper">
            <a href="?page=bp-facebook&amp;tab=configuration" class="nav-tab <?php echo $active_tab == 'configuration' ? 'nav-tab-active' : ''; ?>"><?php _e('Settings'); ?></a>
          <a href="?page=bp-facebook&amp;tab=support" class="nav-tab <?php echo $active_tab == 'support' ? 'nav-tab-active' : ''; ?>"><?php _e('Support'); ?></a>
      <a href="?page=bp-fb-settings" class="nav-tab <?php echo $active_tab == 'support' ? 'nav-tab-active' : ''; ?>"><?php _e('Layout'); ?></a>
        ...
        <form name="form1" method="post" action="">
            ...
            <table class="form-table">
                <tbody>
                    <tr valign="top">
                        <th scope="row"><?php _e('User Name or ID<br />
<i style="font-weight: normal; font-size: 12px;">type username or user id.</i>'); ?></th>
                        <td>
...
function cff_style_page() {
    ...
    <div id="cff-admin" class="wrap">
        ...
        <form name="form1" method="post" action="">
            ...
            ?>
            <h2 class="nav-tab-wrapper">
                <a href="?page=bp-fb-settings&tab=general" class="nav-tab <?php echo $active_tab == 'general' ? 'nav-tab-active' : ''; ?>"><?php _e('General'); ?></a>
    
                <a href="?page=bp-fb-settings&tab=custom_text" class="nav-tab <?php echo $active_tab == 'custom_text' ? 'nav-tab-active' : ''; ?>"><?php _e('Translate'); ?></a>
            </h2>
...
function cff_add_settings_link( $links, $file ) {
    $cff_settings_link = '<a href="' . admin_url( 'admin.php?page=bp-facebook' ) . '">' . __( 'Settings', 'bp-facebook' ) . '</a>';
